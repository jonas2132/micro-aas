...
public class WebController {
    ...
    public String showOverview(Model model) {
        ...
        // add the list of environmentServices to model that its accessible on the
        // frontend
    ...
    public String submission(
        ...
        envServ.updateProperty(Double.toString(PCFQuantityOfMeasureForCalculation), SubmodelType.CARBON_FOOTPRINT,
        ...
        // currentDataRepository.write(envServ, assetIDshort + (currenDataType ==
        // DataType.AASX ? ".aasx" : ".json"));
